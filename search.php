...
class SearchPatientPage extends TabbedPage {
    ...
    function showHtml() {
        ...
        print "</select>\n";
        print "<input type='text' name='todate'>";
        ...
        print "<option>" . pacsone_gettext("To") . "\n";
        print "</select>\n";
        print "<input type='text' name='studytodate'> $format";
        global $CUSTIMIZE_SEARCH_BY_PATIENT;
        print "<P><input type='submit' value='$CUSTIMIZE_SEARCH_BY_PATIENT'></P>\n";
        print "</form>\n";
    }
}
...
class SearchStudyPage extends TabbedPage {
    ...
    function showHtml() {
        ...
        print "<option>" . pacsone_gettext("To") . "\n";
        print "</select>\n";
        print "<input type='text' name='todate'> $format";
        print "<P>" . pacsone_gettext("Accession Number:") . "\n";
        print "<input type='text' name='accession'></P>\n";
        global $CUSTOMIZE_REFERRING_DOC;
        print "<P>$CUSTOMIZE_REFERRING_DOC:\n";
        print "<input type='text' name='referdoc'></P>\n";
        global $CUSTOMIZE_READING_DOC;
        print "<P>$CUSTOMIZE_READING_DOC:\n";
        print "<input type='text' name='readingdoc'></P>\n";
        print "<P>" . pacsone_gettext("Source AE:") . "\n";
        print "<input type='text' name='sourceae' maxlength=16></P>\n";
        print "<P>" . pacsone_gettext("Modalities:") . "\n";
        print "<input type='text' name='modalities'></P>\n";
        ...
        print "<option>" . pacsone_gettext("To") . "\n";
        print "</select>\n";
        print "<input type='text' name='rtodate'> $format";
        ...
        print "<option>" . pacsone_gettext("To") . "\n";
        print "</select>\n";
        print "<input type='text' name='exporttodate'> $format";
        print "<P><input type='submit' value='";
...
class SearchSeriesPage extends TabbedPage {
    ...
    function showHtml() {
        ...
        print "<input type='text' name='modality'></P>\n";
        print "<P>" . pacsone_gettext("Series Description:") . "\n";
        print "<input type='text' name='description'></P>\n";
        print "<P><input type='submit' value='";
...
class SearchWorklistPage extends TabbedPage {
    ...
    function showHtml() {
        ...
        global $CUSTOMIZE_PATIENT_NAME;
        print "<P>$CUSTOMIZE_PATIENT_NAME:\n";
        print "<input type='text' name='patientname'>\n";
        print "<P>" . pacsone_gettext("Accession Number:") . "\n";
        print "<input type='text' name='accession'></P>\n";
        print "<P>" . pacsone_gettext("Modality:") . "\n";
        print "<input type='text' name='modality'></P>\n";
        print "<P>" . pacsone_gettext("Scheduled AE:") . "\n";
        print "<input type='text' name='scheduledae' maxlength=16></P>\n";
        $today = (!$this->eurodate)? date("Y-m-d") : date("d-m-Y");
...
class SearchDicomAePage extends TabbedPage {
    ...
    function showHtml() {
        ...
        print "<input type='text' name='aetitle'>\n";
